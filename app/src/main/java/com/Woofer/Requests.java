...
public class Requests
{
    ...
    final private static String URL_BASE = "https://lamp.ms.wits.ac.za/home/s2332155/"; // All scripts are accessed from this base URL
    ...
    public static String caesarCipher(String message)
    {
        ...
        for (char letter : message.toCharArray())
        {
            ...
            {
                encodedStr.append(letter);
                continue;
            }

            base = Character.isLowerCase(letter) ? 'a' : 'A';
            encodedStr.append((char) ((letter + shift - base) % 26 + base));
        }
